...
#define CURL_URL 10002 // where redirection happens
#define CURL_VERIFYPEER 10064 // where ssl bypassing happens
#define CURL_VERIFYHOST 10081 // where we tell curl that we are real host
// #define CURL_USE_SSL 119 // self explanatory
#define CURL_NOPROXY 10117 // where we turn off proxy
#define CURL_PINNEDPUBLICKEY 10230 // idk

typedef enum class CURLcode {
	CURLE_OK = 0,
